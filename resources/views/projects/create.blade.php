...
@section('content')
    ...
    <body>
        <h1 class="text-4xl mx-8 my-7 text-white">Create Project</h1>
            ...
            <div
                ...
                <form method="post" action="{{ route('project.store') }}">
                    ...
                    <div class="flex flex-row">
                        <button type="submit"
                            class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Create
                            Project</button>
